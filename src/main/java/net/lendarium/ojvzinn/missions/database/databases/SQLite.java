...
public class SQLite extends DataBase implements DatabaseInterface<SQLite> {
    ...
    public void createDefaultTables() {
        createTable("CREATE TABLE IF NOT EXISTS ProfileMissions (`NAME` TEXT, `PROGRESS` TEXT, `COMPLETED` TEXT, `SELECTED` TEXT, `AUTOMISSION` TEXT)");
    }
    ...
    public void addStatusDefaultPlayer(String player, String table) {
        try {
            if (table.equalsIgnoreCase("ProfileMissions")) {
